...
\documentclass[lighthipster]{Mine}
...
\simpleheader{headercolour}{Mahdi}{Jalili}{}{white}
...
\begin{paracol}{2}
	...
	\infobubble{\faLinkedin}{cvgreen}{white}{Love} \texttt{Matlab/C++} ~•~ \texttt{Python} ~•~ \texttt{Linux}
	...
	\begin{tabular}{r| p{0.5\textwidth} c}
		\cvevent{2018--2021}{Captain of the Black Pearl}{Lead}{East Indies \color{cvred}}{Finally got the goddamn ship back.\lorem\lorem\lorem}{profile.jpg} \\
		\cvevent{2016--2017}{Captain of the Black Pearl}{Lead}{Tortuga \color{cvred}}{Found a secret treasure, lost the ship. \lorem\lorem}{profile.jpg}
	\end{tabular}
	\vspace{3em}
	...
	\begin{minipage}[t]{0.35\textwidth}
		...
		\begin{tabular}{r p{0.6\textwidth} c}
			\cvdegree{1710}{Captain}{Certified}{Tortuga Uni \color{headerblue}}{}{profile.jpg} \\
			\cvdegree{1715}{Bucaneering}{M.A.}{London \color{headerblue}}{}{profile.jpg}       \\
			\cvdegree{1720}{Bucaneering}{B.A.}{London \color{headerblue}}{}{profile.jpg}
		\end{tabular}
	\end{minipage}\hfill
	...
	\section*{Curriculum}
	\begin{tabular}{r| p{0.5\textwidth} c}
		\cvevent{2018--2021}{Captain of the Black Pearl}{Lead}{East Indies \color{cvred}}{Finally got the goddamn ship back. \lorem}{profile.jpg} \\
		\cvevent{2019}{Freelance Pirate}{Bucaneering}{Tortuga \color{cvred}}{This and that. The usual, aye?  \lorem}{profile.jpg}                 \\
	\end{tabular}
	\vspace{3em}
